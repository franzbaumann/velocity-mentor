      ...
      <View style={styles.row}>
        ...
        >
          ...
          {activePoint && activeDatum ? (
            ...
            >
              <Text style={styles.tooltipLabel}>{format(new Date(activeDatum.date), "MMM d")}</Text>
              <Text style={styles.tooltipValue}>{`${Math.round(activeDatum.CTL)} ms`}</Text>
            </View>
          ) : null}
        </View>
      </View>
      <View style={styles.xAxisRow}>
        <Text style={styles.axisLabel}>{startDateLabel}</Text>
        <Text style={styles.axisLabel}>{endDateLabel}</Text>
      </View>
    </View>
  );
};
