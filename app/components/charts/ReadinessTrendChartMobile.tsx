...
export const ReadinessTrendChartMobile: FC<Props> = ({ data }) => {
    ...
    <View>
      <View style={styles.row}>
        <View style={styles.yAxis}>
          <Text style={[styles.axisLabel, { color: colors.mutedForeground }]}>{topLabel}</Text>
          <Text style={[styles.axisLabel, { color: colors.mutedForeground }]}>{bottomLabel}</Text>
        </View>
        <View
          style={styles.chart}
