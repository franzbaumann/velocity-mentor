    ...
    <View>
      <View style={styles.row}>
        <View style={styles.yAxisLeft}>
          <Text style={[styles.axisLabel, { color: theme.textMuted }]}>{sleepTop}</Text>
          <Text style={[styles.axisLabel, { color: theme.textMuted }]}>{sleepBottom}</Text>
        </View>
        <View
          style={styles.chart}
        ...
        <View style={styles.yAxisRight}>
          <Text style={[styles.axisLabel, { color: theme.textMuted }]}>{hrTop}</Text>
          <Text style={[styles.axisLabel, { color: theme.textMuted }]}>{hrBottom}</Text>
        </View>
      </View>
