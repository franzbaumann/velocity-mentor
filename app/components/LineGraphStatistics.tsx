...
export const LineGraphStatistics: React.FC = () => {
  ...
  const periods: { label: PeriodKey; color: string }[] = [
    { label: "Last 3 months", color: theme.accentGreen },
    { label: "Last 30 days", color: theme.accentBlue },
    { label: "Last 7 days", color: theme.accentOrange },
  ];

  const metrics: MetricsConfig[] = [
    { label: "Peak", value: currentData.peak, color: theme.accentBlue },
    { label: "Average", value: currentData.average, color: theme.accentOrange },
    { label: "Growth", value: currentData.growth, color: theme.accentGreen },
  ];
  ...
  return (
    <View style={[styles.root, { backgroundColor: theme.cardBackground }]}>
      ...
      <View style={[styles.card, { borderColor: theme.cardBorder, backgroundColor: theme.appBackground }]}>
        <View style={styles.legendRow}>
          ...
          >
            <View style={[styles.legendDot, { borderColor: theme.accentBlue, backgroundColor: theme.chartFill }]} />
            <Text style={[styles.legendLabel, { color: theme.textMuted }]}>Mobile</Text>
          ...
          >
            <View style={[styles.legendDot, { borderColor: theme.chartGrid, backgroundColor: theme.surfaceElevated }]} />
            <Text style={[styles.legendLabel, { color: theme.textMuted }]}>Desktop</Text>
            <Text style={[styles.legendValue, { color: theme.textPrimary }]}>
          ...
          {periods.map((p, index) => (
            <Pressable
              ...
              style={[
                ...
                {
                  backgroundColor:
                    selectedPeriod === p.label ? theme.textPrimary : theme.appBackground,
              ...
              <View style={styles.periodTopRow}>
                ...
                <Text
                  style={[
                    ...
                    {
                      color:
                        selectedPeriod === p.label ? theme.appBackground : theme.textMuted,
                    },
                  ]}
                >
                  {p.label}
        ...
        <View style={styles.metricsRow}>
          <View style={styles.metricsLeft}>
            {metrics.map((m) => (
              ...
              >
                ...
                <Text style={[styles.metricValue, { color: theme.textPrimary }]}>{m.value}</Text>
              </View>
            ))}
          </View>
          <View
          ...
          >
            <Text style={[styles.bundleLabel, { color: theme.primaryForeground }]}>Bundle size</Text>
            <Text style={[styles.bundleValue, { color: theme.primaryForeground }]}>
