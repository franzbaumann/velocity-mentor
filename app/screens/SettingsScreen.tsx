...
export const SettingsScreen: FC = () => {
  ...
  return (
    <ScreenContainer contentContainerStyle={styles.content}>
      ...
      <GlassCard>
        <Text style={[styles.sectionHeader, typography.sectionHeader]}>Connected Accounts</Text>
      ...
      <GlassCard>
        <Text style={[styles.sectionHeader, typography.sectionHeader]}>Heart Rate</Text>
        <Text style={styles.body}>Max HR and zones can be set here once wired to profile.</Text>
      </GlassCard>

      <GlassCard>
        <Text style={[styles.sectionHeader, typography.sectionHeader]}>Training Preferences</Text>
        <Text style={styles.body}>Theme and notification preferences will appear here.</Text>
      </GlassCard>

      <GlassCard>
        <Text style={[styles.sectionHeader, typography.sectionHeader]}>Account</Text>
